...
int main(void) {
	int ARR_NUM_BLOCK[8] = {60, 120, 180, 240, 300, 360, 420, 600};
	int ARR_NUM_THREAD[10] = {16, 32, 48, 64, 80, 96, 112, 128, 144, 160};
	for (int i = 0; i < 8; i++) {
		for (int j = 0; j < 10; j++) {
			int NUM_BLOCK  = ARR_NUM_BLOCK[i];
			int NUM_THREAD = ARR_NUM_THREAD[j];
